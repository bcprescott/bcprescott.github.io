...
$$E_t >= n - D_a + {E_t}_-1$$ - defines the duration of each tasks in relation to it's previous dependent tasks's occurent in the project

$${E_1}_2 <=$$ _project deadline requirement (in days)_
